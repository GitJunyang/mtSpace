package com.moutum.mtplatform.common.operlog;
...
import com.moutum.mtplatform.common.utils.IPAddressUtil;
...
public class SysOperLogAspect {
	...
	@Pointcut("@annotation(com.moutum.mtplatform.common.operlog.SysLog)")
	...
	public void after(JoinPoint joinPoint, Object rvt) {
		try {
			...
			if(loginUser==null){
				throw new UnauthenticatedException("系统没有认证信息!");
			}
