package com.moutum.mtplatform.common.zcode;
...
import com.moutum.mtplatform.common.generator.AutoGenerator;
import com.moutum.mtplatform.common.generator.InjectionConfig;
...
//        strategy.setTablePrefix("bmd_");// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] {"sys_oper_log"}); // 需要生成的表//-----------------------------3.配置你要生成的表的表名-----------------------------------------------
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.moutum.mtplatform.common.base.BaseController");
        ...
        pc.setParent("com.moutum.mtplatform");
