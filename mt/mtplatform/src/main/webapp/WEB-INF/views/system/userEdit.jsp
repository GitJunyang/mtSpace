    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userEditForm" method="post">
            ...
            <table class="grid">
                ...
                <tr>
                    <td>密码</td>
                    <td><input type="text" name="loginPwd" class="easyui-textbox" style="width: 140px; height: 29px;"/></td>
                    <td>性别</td>
                ...
                <tr>
                    ...
                    <td>电话</td>
                    <td>
                        <input type="text" name="userPhone" class="easyui-numberbox" style="width: 140px; height: 29px;" value="${user.userPhone}"/>
                    </td>
                </tr>
                <tr>
                    <td>部门</td>
