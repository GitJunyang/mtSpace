...
<div style="padding: 3px;">
    <form id="departmentEditForm" method="post">
        <table class="grid">
        	<tr>
            	<td>资源名称</td>
                <td><input name="departmentName" class="easyui-textbox" style="width: 240px; height: 29px;" type="text" value="${department.departmentName}" placeholder="请输入部门名称" class="easyui-validatebox" data-options="required:true" ></td>
            </tr>
            <tr>
                <td>编号</td>
                <td>
                	<input name="id" type="hidden"  value="${department.id}">
                	<input name="departmentCode" style="width: 240px; height: 29px;" type="text" class="easyui-textbox" value="${department.departmentCode}" />
                </td>
            </tr>
            <tr>
                <td>排序</td>
